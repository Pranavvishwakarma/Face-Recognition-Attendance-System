...
class Developer:
    def __init__(self,root):
        ...
        # Developer Info
        dev_lb=Label(main_frame,text="Pranav Vishwakarma",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=45)

        dev_lb=Label(main_frame,text="Sachin Prajapati",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=95)

        dev_lb=Label(main_frame,text="Prajwal Thakur",font=("time new roman",15,"bold"),bg="white",fg="#142552")
        dev_lb.place(x=10,y=145)

        dev_lb=Label(main_frame,text="Mayuri Kaushal",font=("time new roman",15,"bold"),bg="white",fg="#142552")
